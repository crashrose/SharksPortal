...
class attendanceTableResponses extends JTable {
	...
	public function store($keyItem, $updateNulls = false, $createOnly = false) {
		...
		if ($createOnly) {
			$setInactive = $this->setAsInactive ( $keyItem );
	...
	public function setAsInactive($keyItem) {
		$where = ' WHERE event_user = \'' . $keyItem . '\'';
