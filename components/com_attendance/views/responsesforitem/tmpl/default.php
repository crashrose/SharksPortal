...
<form
	action="<?php echo JRoute::_('index.php?option=com_attendance&view=ResponsesForItem'); ?>"
	method="post" name="adminForm" id="adminForm">
Filter by:
<BR><span>
<div style="display:inline;"><?php echo AttendanceHelper::report_compl_filter($this->state->get('filter.cmpl'));?></div>
</span>
	...
	<div>
		...
		<input type="hidden" name="filter_id" value="<?php echo $this->FilterID; ?>" />
		<input type="hidden" name="filter_type" value="<?php echo $this->FilterType; ?>" />
