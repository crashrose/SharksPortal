...
$url1	= "http://templatesjoomla.org/";
$text1	= array("Joomla Templates","Joomla 3.1 Templates","Free Joomla Templates","Simple Joomla", "Clean Joomla","Best Joomla","Plantillas Joomla","Joomla Tema","Joomla Styles", "Joomla Shop");
...
echo "<a target='_blank' title='Joomla Templates' href='".$url1."'>".$text1[$host]."</a> by <a target='_blank' title='ipage' href='".$url2."'>".$text2[$host]."</a>";
}
?>